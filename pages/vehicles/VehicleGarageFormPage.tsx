...
const VehicleGarageFormPage = () => {
  ...
  return (
    <div>
      <PageHeader title={isEditing ? 'Edit Garage' : 'New Garage'} breadcrumbs={breadcrumbs} />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
             ...
             <div>
              ...
              <input type="text" name="location" id="location" className="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm" />
            </div>
            <div>
